...
import "./jegyvarsarlas.css";

export default function Jegyvasarlas() {
return ( <div> <form action="#"> <select name="Közlekedési eszközök" id="kozeszk"> <option value="vasut">Vasút</option> <option value="busz">Busz</option> <option value="hev">Hév</option> </select> <br />
